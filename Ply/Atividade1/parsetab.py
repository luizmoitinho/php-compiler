...
_lr_action_items = {'NUMBER':([0,9,10,11,12,],[6,6,6,6,6,]),'ID':([0,9,10,11,12,13,21,],[7,7,7,7,7,18,18,]),'$end':([1,2,3,4,5,6,7,8,14,15,16,17,20,22,],[0,-2,-4,-6,-7,-8,-9,-10,-1,-3,-5,-15,-12,-11,]),'SOMA':([1,2,3,4,5,6,7,8,14,15,16,17,20,22,],[9,-2,-4,-6,-7,-8,-9,-10,-1,-3,9,9,-12,-11,]),'VEZES':([2,3,4,5,6,7,8,14,15,16,17,20,22,],[10,-4,-6,-7,-8,-9,-10,10,-3,-5,-15,-12,-11,]),'POT':([2,3,4,5,6,7,8,14,15,16,17,20,22,],[-2,-4,11,-7,-8,-9,-10,-1,-3,-5,-15,-12,-11,]),'IGUAL':([7,],[12,]),'LPAREN':([7,],[13,]),'RPAREN':([13,18,19,23,],[20,-14,22,-13,]),'COMMA':([18,],[21,]),}
...
_lr_goto_items = {'exp':([0,11,12,],[1,16,17,]),'exp1':([0,9,11,12,],[2,14,2,2,]),'exp2':([0,9,10,11,12,],[3,3,15,3,3,]),'exp3':([0,9,10,11,12,],[4,4,4,4,4,]),'assign':([0,9,10,11,12,],[5,5,5,5,5,]),'call':([0,9,10,11,12,],[8,8,8,8,8,]),'params':([13,21,],[19,23,]),}
...
_lr_productions = [
  ...
  ('exp2 -> exp3 POT exp','exp2',3,'p_exp2_expo','ExpressionLanguageParser.py',28),
  ...
  ('params -> ID COMMA params','params',3,'p_params','ExpressionLanguageParser.py',59),
  ('params -> ID','params',1,'p_params','ExpressionLanguageParser.py',60),
  ('assign -> ID IGUAL exp','assign',3,'p_assign','ExpressionLanguageParser.py',67),
]
